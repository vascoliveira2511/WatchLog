    ...
    episodes: [
      {
        ...
        airDate: "2008-01-20",
        runtime: 58,
        overview: "Walter White, a struggling high school chemistry teacher, is diagnosed with advanced lung cancer. He turns to a life of crime and partners with a former student, Jesse Pinkman, in a quest to secure his family's financial future.",
        watched: true,
        rating: 5,
      },
      {
...
export default function ShowDetailsPage() {
  ...
  const handleBulkMarkWatched = (episodeIds: number[]) => {
    setSeasons(prev => prev.map(season => ({
      ...season,
      episodes: season.episodes.map(episode =>
        episodeIds.includes(episode.id) ? { ...episode, watched: true } : episode
      )
    })));
              ...
              <div className="text-white space-y-4 max-w-2xl">
                <div>
                  ...
                  <p className="text-lg text-gray-300">
                    {show.year}{show.endYear && ` - ${show.endYear}`} • {show.seasons} Season{show.seasons > 1 ? 's' : ''} • {show.network}
                  </p>
                </div>
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <Badge variant={show.status === "completed" ? "default" : "secondary"}>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Button
                variant="outline"
                size="icon"
                onClick={() => setSelectedSeason(Math.min(show.seasons, selectedSeason + 1))}
        ...
        <TabsContent value="similar">
          <Card>
            ...
            <CardContent>
              <p className="text-gray-500">Similar shows will appear here based on your viewing history and preferences.</p>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="activity">
          <Card>
            ...
            <CardContent>
              <p className="text-gray-500">Your watch history and activity for this show will appear here.</p>
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
