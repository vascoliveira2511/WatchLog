...
const mockStats = {
  ...
  achievements: [
    ...
    },
    {
      id: 3,
      name: "Genre Explorer",
      description: "Watch shows from 10 different genres",
      completed: true,
      date: "2024-03-10",
    },
    {
    ...
    },
    {
      id: 5,
      name: "Rating Master",
      description: "Rate 100 episodes/movies",
      completed: false,
      progress: 73,
    },
    {
...
export default function StatsPage() {
  ...
  useEffect(() => {
    const loadUserStats = async () => {
      try {
        // Load real data from trackingService
        ...
        setUserStats({
          ...
          overview: {
            ...mockStats.overview,
            totalMovies: stats.moviesWatched,
            totalShows: stats.showsWatched,
            totalEpisodes: stats.episodesWatched,
            totalTimeWatched: stats.totalWatchTime,
          },
        });
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-3xl font-bold text-white">
                    {formatNumber(userStats.overview.totalEpisodes)}
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-3xl font-bold text-white">
                    {userStats.overview.totalMovies}
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-3xl font-bold text-white">
                    {formatHours(userStats.overview.totalTimeWatched)}h
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-3xl font-bold text-white">
                    {userStats.overview.averageRating}
                  </p>
                </div>
              </div>
            </CardContent>
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-semibold text-white">
                          {formatTime(
                            userStats.watchingPatterns.averageSessionLength
                          )}
                        </span>
                      </div>
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-semibold text-white">
                          {userStats.overview.completionRate}%
                        </span>
                      </div>
                    </div>
                  </CardContent>
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-3 gap-6 text-center">
                      ...
                      <div>
                        <p className="text-4xl font-bold text-emerald-400">
                          {formatHours(userStats.thisYear.timeWatched)}h
                        </p>
                        <p className="text-sm text-gray-400 mt-1">
                          Hours This Year
                        </p>
                    ...
                    <div className="mt-8 p-8 bg-white/5 border border-white/10 text-center">
                      <p className="text-gray-400">
                        📊 Monthly activity chart will be displayed here using a
                        charting library
                      </p>
                    </div>
                  </div>
